...
<script>
// Kunci Perubahan: Definisikan prop showNavbar di Layout agar dapat diterima dari Page (Dashboard.vue)
export default {
    props: {
        showNavbar: {
            type: Boolean,
            default: true // Default true agar tidak tersembunyi di halaman lain
        }
    }
}
</script>
