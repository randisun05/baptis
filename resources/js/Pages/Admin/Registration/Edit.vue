                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select 
                                        class="form-select input-tegas bg-light-subtle" 
...
const prepareFormData = (data) => {
    ...
    let formData = {
        ...
        family_members: data.family_members && data.family_members.length > 0 ? 
            ...
            [{ id: null, name: '', relation: '', religion: '', address: '', contact: '' }], // Default array

        // Data Katekumen
        address: data.data_katekumen?.address || '',
        ...
        dateStart: formatDate(data.data_riwayat?.dateStart),
        dateEnd: formatDate(data.data_riwayat?.dateEnd),
        participateBefore: data.data_riwayat?.participateBefore || '',
        nameGuru: data.data_riwayat?.nameGuru || '',
        nameGereja: data.data_riwayat?.nameGereja || '',
        addressGereja: data.data_riwayat?.addressGereja || '',
        namePriest: data.data_riwayat?.namePriest || '',
